...
Registry::getInstance()->router->addRoute(Route::get('Controllers\Browse', 'user', 'user/([^/]+)/'));
Registry::getInstance()->router->addRoute(Route::get('Controllers\Browse', 'user', 'user/([^/]+)/([0-9]+)/'));
